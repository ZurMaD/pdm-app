...
class LoaderDrawerMenu extends StatefulWidget {
  @override
  _LoaderDrawerMenuState createState() => _LoaderDrawerMenuState();
}

class _LoaderDrawerMenuState extends State<LoaderDrawerMenu> {
  startTime() async {
